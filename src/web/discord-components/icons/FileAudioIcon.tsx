export default function FileAudioIcon(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg fill="none" height="96" viewBox="0 0 72 96" width="72" xmlns="http://www.w3.org/2000/svg" {...props}>
			<path
